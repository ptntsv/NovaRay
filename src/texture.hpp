...
class basic_noise_texture : public texture {
public:
    basic_noise_texture() {}
...
class interpolated_noise_texture : public texture {
public:
    interpolated_noise_texture(double sc) : scale(sc) {}
